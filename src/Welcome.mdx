...
## Colours
Topaz uses tailwindcss [colour palette](https://tailwindcss.com/docs/customizing-colors). You can customize them in uno.config.ts file located in the root folder.
